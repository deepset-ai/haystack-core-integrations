...
from haystack_integrations.components.connectors.github.file_editor import GithubFileEditor, Command
...
class TestGithubFileEditor:
    ...
    def test_run_edit(self, mock_put, mock_get):
        ...
        mock_get.assert_called_once_with(
            ...
            headers={"Accept": "application/vnd.github.v3+json", "User-Agent": "Haystack/GithubFileEditor", "Authorization": "Bearer test_token"},
            params={"ref": "main"}
        )
    ...
    def test_run_undo(self, mock_patch, mock_get):
        ...
        mock_get.side_effect = [
            type("Response", (), {"json": lambda: [{"author": {"login": "testuser"}}], "raise_for_status": lambda: None}),
            type("Response", (), {"json": lambda: [{"sha": "abc123"}, {"sha": "def456"}], "raise_for_status": lambda: None})
        ]
