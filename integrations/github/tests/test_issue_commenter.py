...
class TestGithubIssueCommenter:
    ...
    def test_to_dict(self):
        ...
        assert result["type"] == "haystack_integrations.components.connectors.github.issue_commenter.GithubIssueCommenter"
    ...
    def test_run(self, mock_post):
        ...
        mock_post.assert_called_once_with(
            ...
            headers={"Accept": "application/vnd.github.v3+json", "User-Agent": "Haystack/GithubIssueCommenter", "Authorization": "Bearer test_token"},
