...
class TestGoogleAIDocumentEmbedder:
    def test_init_default(self, monkeypatch):
        monkeypatch.setenv("GOOGLE_API_KEY", "fake-api-key")
        embedder = GoogleAIDocumentEmbedder()
    ...
    def test_run_wrong_input_format(self):
        ...
        with pytest.raises(TypeError, match="GoogleAIDocumentEmbedder expects a list of Documents as input"):
    ...
    def test_run(self):
        ...
        embedder = GoogleAIDocumentEmbedder(model=model, meta_fields_to_embed=[
