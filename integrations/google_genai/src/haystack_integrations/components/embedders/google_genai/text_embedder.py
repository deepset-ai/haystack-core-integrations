...
class GoogleAITextEmbedder:
    ...
    ```python
    from haystack.components.embedders import GoogleAITextEmbedder

    text_to_embed = "I love pizza!"

    text_embedder = GoogleAITextEmbedder()
    ...
    def __init__(  # pylint: disable=too-many-positional-arguments
        ...
        """
        Creates an GoogleAITextEmbedder component.
    ...
    def _prepare_input(self, text: str) -> Dict[str, Any]:
        ...
        kwargs: Dict[str, Any] = {
            "model": self._model_name, "contents": text_to_embed}
        if self._config:
