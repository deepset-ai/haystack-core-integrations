...
# This example demonstrates how to use the RequestyChatGenerator component
...
from haystack_integrations.components.generators.requesty import RequestyChatGenerator
...
component = RequestyChatGenerator(generation_kwargs={"response_format": NobelPrizeInfo})
