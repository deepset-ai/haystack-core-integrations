...
class TestRequestyChatGeneratorAsync:
    @pytest.mark.asyncio
    async def test_warm_up_async(self, monkeypatch):
        ...
        assert component.async_client.base_url == "https://router.requesty.ai/v1/"
    ...
    async def test_live_run_with_tools_streaming_async(self, tools):
        ...
        component = RequestyChatGenerator(tools=tools, streaming_callback=callback)
