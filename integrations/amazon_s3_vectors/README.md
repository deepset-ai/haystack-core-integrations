...
- [Integration page](https://haystack.deepset.ai/integrations/amazon-s3-vectors)
- [Changelog](https://github.com/deepset-ai/haystack-core-integrations/blob/main/integrations/amazon_s3_vectors/CHANGELOG.md)
---
