...
class TestKeywordRetrieval:
    def test_keyword_retrieval(self, document_store: SupabasePgvectorDocumentStore):
        docs = [
    ...
    def test_keyword_retrieval_with_filters(self, document_store: SupabasePgvectorDocumentStore):
        docs = [
            Document(
    ...
    def test_empty_query(self, document_store: SupabasePgvectorDocumentStore):
        with pytest.raises(ValueError):
