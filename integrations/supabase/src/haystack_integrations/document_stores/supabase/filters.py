...
def _normalize_filters(filters: Dict[str, Any]) -> Dict[str, Any]:
    """
    Converts Haystack filters in Supabase compatible filters.
    Reference: https://supabase.com/docs/guides/ai/python/metadata
    """
...
def _parse_comparison_condition(condition: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if field.startswith("meta."):
        ...
        # Documents are flattened when using the SupabaseDocumentStore
...
def _equal(field: str, value: Any) -> Dict[str, Any]:
    ...
    if not isinstance(value, supported_types):
        msg = (
            ...
            f"Types supported by Supabase are: {supported_types}"
        )
        raise FilterError(msg)
