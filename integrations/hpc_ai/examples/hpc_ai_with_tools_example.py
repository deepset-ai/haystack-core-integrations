...
"""Run HPC-AI chat generation with tool calling and execution."""
...
def main() -> None:
    """Demonstrate calling a tool and feeding the result back to HPC-AI."""
    ...
    client = HPCAIChatGenerator(model="moonshotai/kimi-k2.5")
