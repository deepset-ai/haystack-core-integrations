...
CONTEXTS = [
    [
        (
            ...
            "presence, number of participants, and economic impact."
        ),
        (
            "Football is undoubtedly the world's most popular sport with major events like the FIFA World Cup and "
            "sports personalities like Ronaldo and Messi, drawing a followership of more than 4 billion people."
        ),
    ],
    [
        "Python, created by Guido van Rossum in the late 1980s, is a high-level general-purpose programming language.",
        (
            "Its design philosophy emphasizes code readability, and its language constructs aim to help programmers "
