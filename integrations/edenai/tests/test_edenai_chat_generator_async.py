...
from haystack_integrations.components.generators.edenai.chat.chat_generator import (
    EdenAIChatGenerator,
)
...
class TestEdenAIChatGeneratorAsync:
    def test_init_default_async(self, monkeypatch):
        ...
        assert component.async_client.base_url == "https://api.edenai.run/v3/"
    ...
    async def test_live_run_with_tools_and_response_async(self, tools):
        """
        Integration test that the EdenAIChatGenerator component can run with tools and get a response.
        """
