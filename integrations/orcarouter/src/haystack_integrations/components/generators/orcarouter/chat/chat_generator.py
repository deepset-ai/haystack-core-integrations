...
class OrcaRouterChatGenerator(OpenAIChatGenerator):
    ...
    def __init__(
        ...
        *,
        ...
        :param api_base_url:
            The OrcaRouter API base URL. For more details, see the OrcaRouter
            [documentation](https://docs.orcarouter.ai).
        :param organization:
            Your OrcaRouter organization ID, if any.
        :param generation_kwargs:
            Other parameters to use for the model. These parameters are sent directly to the OrcaRouter endpoint.
