...
class ElasticsearchDocumentStore:
    ...
    def _create_dense_retrieval_inference_body(
        self,
        query: str,
        inference_id: str,
        *,
        ...
        """
        Builds the Elasticsearch kNN search body for server-side dense retrieval using an inference endpoint.

        The query embedding is generated by Elasticsearch via the inference API — no local embedding
        model is required. Uses ``knn.query_vector_builder`` (available since ES 8.0).

        :param query: Query text to embed and search with.
        :param inference_id: Elasticsearch inference endpoint ID (e.g. ``".multilingual-e5-small-elasticsearch"``).
        :param filters: Optional filters to narrow down the search space.
        :param top_k: Maximum number of documents to return.
        ...
        """
        if not query:
            msg = "query must be a non-empty string for inference-based dense retrieval"
            raise ValueError(msg)
    ...
    def _dense_retrieval_inference(
        self,
        query: str,
        inference_id: str,
        *,
        ...
        """
        Retrieves documents using server-side dense vector inference search.

        Elasticsearch generates the query embedding from ``query`` using the specified inference
        endpoint — no local embedder is needed.

        :param query: Query text to use for inference-based dense retrieval.
        :param inference_id: Elasticsearch inference endpoint ID.
        :param filters: Optional filters to narrow down the search space.
        :param top_k: Maximum number of documents to return.
    ...
    async def _dense_retrieval_inference_async(
        self,
        query: str,
        inference_id: str,
        *,
        ...
        """
        Asynchronously retrieves documents using server-side dense vector inference search.
