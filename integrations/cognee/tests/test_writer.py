...
class TestCogneeWriter:
    ...
    def test_to_dict(self):
        ...
        data = writer.to_dict()
        assert data["type"] == "haystack_integrations.components.connectors.cognee.writer.CogneeWriter"
        assert data["init_parameters"]["dataset_name"] == "test_ds"
        assert data["init_parameters"]["auto_cognify"] is False

    def test_from_dict(self):
        data = {
            "type": "haystack_integrations.components.connectors.cognee.writer.CogneeWriter",
    ...
    @patch("haystack_integrations.components.connectors.cognee.writer.cognee")
