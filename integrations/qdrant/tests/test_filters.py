            ...
            filters=models.Filter(
                must_not=[
                    models.FieldCondition(
                        key="meta.number", match=models.MatchValue(value=100)
                    ),
                    models.FieldCondition(
                        key="meta.name", match=models.MatchValue(value="name_0")
                    ),
                ]
            )
        )
    ...
    def test_filter_criteria(self, document_store):
        documents = [
            Document(
                ...
                meta={
                    "file_name": "file1",
                    "classification": {"details": {"category1": 0.9, "category2": 0.3}},
                },
            ),
            Document(
                ...
                meta={
                    "file_name": "file2",
                    "classification": {"details": {"category1": 0.1, "category2": 0.7}},
                },
            ),
            Document(
                ...
                meta={
                    "file_name": "file3",
                    "classification": {"details": {"category1": 0.7, "category2": 0.9}},
                },
            ),
        ]
        ...
        filter_criteria = {
            ...
            "conditions": [
                ...
                },
                {
                    ...
                    "conditions": [
                        {
                            "field": "meta.classification.details.category1",
                            "operator": ">=",
                            "value": 0.85,
                        },
                        {
                            "field": "meta.classification.details.category2",
                            "operator": ">=",
                            "value": 0.85,
                        },
                    ],
        ...
        self.assert_documents_are_equal(
            ...
            [
                ...
                and (
                    (
                        d.meta.get("classification").get("details").get("category1")
                        >= 0.85
                    )
                    or (
                        d.meta.get("classification").get("details").get("category2")
                        >= 0.85
                    )
                )
            ],
                    ...
                    "conditions": [
                        ...
                        },
                        {
                            ...
                            "conditions": [
                                ...
                                {
                                    "field": "meta.classification.details.category3",
                                    "operator": ">=",
                                    "value": 0.9,
                                },
                            ],
            ...
            [
                ...
                and (
                    ...
                    and (
                        ...
                        or (
                            d.meta.get("classification").get("details").get("category3")
                            >= 0.9
                        )
                    )
                )
