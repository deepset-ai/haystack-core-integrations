...
class TestAmazonBedrockChatGeneratorInference:
    ...
    @pytest.mark.parametrize("model_name", MODELS_TO_TEST)
    @pytest.mark.integration
    def test_metadata_in_response(self, model_name, chat_messages):
    ...
    @pytest.mark.parametrize("model_name", MODELS_TO_TEST)
    @pytest.mark.integration
    async def test_metadata_in_async_response(self, model_name, chat_messages):
    ...
    @pytest.mark.parametrize("model_name", MODELS_TO_TEST)
    @pytest.mark.integration
    def test_metadata_with_streaming(self, model_name, chat_messages):
    ...
    @pytest.mark.parametrize("model_name", MODELS_TO_TEST)
    @pytest.mark.integration
    async def test_metadata_with_async_streaming(self, model_name, chat_messages):
