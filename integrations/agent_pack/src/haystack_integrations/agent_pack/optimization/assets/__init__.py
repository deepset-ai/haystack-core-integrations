...
"""The catalog of models, tools and configuration changes a candidate harness may be built from."""
...
__all__ = ["ApprovedAssetCatalog", "HarnessPatch", "ModelAsset", "ToolAsset"]
