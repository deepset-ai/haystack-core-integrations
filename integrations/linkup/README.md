...
[![PyPI - Version](https://img.shields.io/pypi/v/linkup-haystack.svg)](https://pypi.org/project/linkup-haystack)
...
To run integration tests locally, you need to export the `LINKUP_API_KEY` environment variable.
