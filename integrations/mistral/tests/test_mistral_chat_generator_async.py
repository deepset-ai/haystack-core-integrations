...
class TestMistralChatGeneratorAsync:
    ...
    async def test_live_run_with_tools_and_response_async(self, tools):
        ...
        component = MistralChatGenerator(tools=tools)
        results = await component.run_async(messages=initial_messages, generation_kwargs={"tool_choice": "any"})
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_live_run_with_tools_streaming(self, tools):
        """
                        ...
                        "tools": [
                            {
                                ...
                                "data": {
                                    ...
                                    "description": "useful to determine the weather in a given location",
                                    "parameters": {"city": {"type": "string"}},
                                    "function": "tests.test_mistral_chat_generator_async.weather",
                                },
                            }
                        ],
                    },
