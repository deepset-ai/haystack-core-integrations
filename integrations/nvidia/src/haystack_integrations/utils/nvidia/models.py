...
class Model:
    ...
    client: client name, e.g. NvidiaGenerator, NvidiaChatGenerator,
    ...
    client: Optional[Literal["NvidiaGenerator", "NvidiaTextEmbedder", "NvidiaDocumentEmbedder", "NvidiaRanker", "NvidiaChatGenerator"]] = None
